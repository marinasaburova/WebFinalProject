        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card mb-4 sticky-top" style="top: 72px; z-index:1018;">
                    <img class=" card-img-top" src="<?php echo $path ?>" alt="Image of product" />
            ...
            <div class="col-md-7">
                ...
                <form action="." method="post" enctype="multipart/form-data">
                    <input type="hidden" name="action" value="test-img-upload">
                    <input type="hidden" name="itemid" value="0000000003">
